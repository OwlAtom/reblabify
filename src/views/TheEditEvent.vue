...
<template>
  ...
  <form @submit.prevent="submitForm">
    ...
    <div v-if="!showPopup" class="wrapper overlay">
      ...
      <input v-model="eventData.title" type="text" name="title" />

      <div class="set-time">
        <label for="startDate">
          Start dato
          <input v-model="eventData.startDate" type="date" name="startDate" />
        </label>

        <label for="startTime">
          Start tidspunkt
          <input v-model="eventData.startTime" type="time" name="startTime" />
        </label>
      </div>
      ...
      <div class="set-time">
        <label for="endDate">
          Slut dato
          <input v-model="eventData.endDate" type="date" name="endDate" />
        </label>

        <label for="endDate">
          Slut tidspunkt
          <input v-model="eventData.endTime" type="time" name="endTime" />
        </label>
      </div>
